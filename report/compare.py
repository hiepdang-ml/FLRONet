...
# MAE subplot
axs[0].plot(v_flronetfno, mae_flronetfno, label='flronet-fno', marker='s', color='tab:blue', linestyle='-')
axs[0].plot(v_flronetmlp, mae_flronetmlp, label='flronet-mlp', marker='s', color='tab:green', linestyle='--')
axs[0].plot(v_flronetunet, mae_flronetunet, label='flronet-unet', marker='s', color='tab:red', linestyle='--')
axs[0].plot(v_fno3d, mae_fno3d, label='fno3d', marker='s', color='tab:brown', linestyle='--')
...
# RMSE subplot
axs[1].plot(v_flronetfno, rmse_flronetfno, label='flronet-fno', marker='s', color='tab:blue', linestyle='-')
axs[1].plot(v_flronetmlp, rmse_flronetmlp, label='flronet-mlp', marker='s', color='tab:green', linestyle='--')
axs[1].plot(v_flronetunet, rmse_flronetunet, label='flronet-unet', marker='s', color='tab:red', linestyle='--')
axs[1].plot(v_fno3d, rmse_fno3d, label='fno3d', marker='s', color='tab:brown', linestyle='--')
